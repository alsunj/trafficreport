...
// using vehicle = App.DTO.v1_0.Vehicle;
// using violation = App.DTO.v1_0.Violation;
// using additionalVehicle = App.DTO.v1_0.AdditionalVehicle;
// using evidence = App.DTO.v1_0.Evidence;
// using commment = App.DTO.v1_0.Comment;
// using EVehicleSize = App.Domain.Vehicles.EVehicleSize;
// using EViolationType = App.Domain.Violations.EViolationType;
// using Vehicle = App.BLL.DTO.Vehicle;
// using VehicleViolation = App.BLL.DTO.VehicleViolation;
//
...
//     };
//
//     public VehicleViolationControllerTest(CustomWebApplicationFactory<Program> factory, ITestOutputHelper testOutputHelper)
//     {
//         _factory = factory;
...
//     
//     
//     [Fact(DisplayName = "POST - login, create vehicle, violation, VehicleViolation and log out")]
//     public async Task RegisterToVehicleViolation()
//     {
//         var responseContent = await LoginAndCreateUser("registration@test.ee");
//         
//         var jwtData = JsonSerializer.Deserialize<JWTResponse>(responseContent, _camelCaseJsonSerializerOptions);
//         // Act
//         var VehicleViolation = JsonSerializer.Deserialize<VehicleViolation>(await CreateVehicleViolation(jwtData!, "POST VALUE"), _camelCaseJsonSerializerOptions)!;
//         
//         // Assert
//         Assert.NotNull(VehicleViolation.VehicleViolationName);
//         Assert.NotNull(VehicleViolation.Federation);
//         Assert.NotNull(VehicleViolation.Description);
//         Assert.NotNull(VehicleViolation.RuleSet);
//         Assert.NotEqual(default, VehicleViolation.StartsAt);
//         Assert.NotEqual(default, VehicleViolation.EndsAt);
//         
//         var url = $"/api/v1.0/UserDatas/{jwtData!.Id}";
//     
//         var request = new HttpRequestMessage(HttpMethod.Get, url);
//         request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", jwtData.Jwt);
//     
...
//         
//         var result = await response.Content.ReadAsStringAsync();
//         var userData = JsonSerializer.Deserialize<UserData>(result, _camelCaseJsonSerializerOptions)!;
//         
//         url = $"/api/v1.0/Registrations";
//     
//         var registration = new Registration()
//         {
//             UserDataId = userData.Id,
//             CompId = VehicleViolation.Id,
...
//         };
//     
//         var content = JsonContent.Create(registration);
//         
//         _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", jwtData!.Jwt);
//     
...
//         };
//     
//         var data = JsonContent.Create(logout);
//     
//         _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", jwtData.Jwt);
//     
//         // Act
